    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={{ paddingHorizontal: 18, paddingBottom: 40 }}>
        ...
        <View style={styles.content}>
          ...
          >
            <View style={styles.uploadInner}>
              ...
              <Text style={styles.uploadText}>
                {loadingImage ? 'Loading...' : image ? 'Change Image' : 'Upload Image'}
              </Text>
            </View>
          </Pressable>
          ...
          <Pressable
            onPress={runAnalysis}
            style={[styles.uploadBtn, styles.analysisBtn, analyzing && styles.disabledBtn]}
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.modalCard}>
                ...
                {nurseryOptions.map((n) => (
                  <TouchableOpacity
                    key={n}
                    onPress={() => { setNursery(n); setShowNurseryModal(false); }}
                ...
                {result && (
                  <>
                      ...
                      <View style={styles.analysisSummary}>
                        <Text
                          style={[
                            ...
                            { color: severity(result.bleaching_percentage).color },
                          ]}
                        >
                    ...
                    <View style={styles.analysisButtonsRow}>
                      ...
                      <TouchableOpacity
                        style={[styles.analysisAction, styles.suggestionsAction]}
                        onPress={() => Alert.alert('Suggestions', 'Show restoration suggestions here.')}
                      >
                        <Text style={[styles.analysisActionText, styles.suggestionsActionText]}>
                          Suggestions
                        </Text>
                      </TouchableOpacity>
                    </View>
